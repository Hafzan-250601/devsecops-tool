If you want to run the MathSheet app using docker compose locally dont forget to add .env file in the root path of your directory for the secrets. Hope you enjoy!
